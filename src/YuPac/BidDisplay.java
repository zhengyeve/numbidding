 ...
 * @author yufan
 */
public class BidDisplay extends javax.swing.JFrame {

    /**
     * Creates new form BidDisplay
     */
    public BidDisplay() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("PO1");
        jPanel4.add(jLabel10);

        jLabel11.setText("PO1");
        jPanel4.add(jLabel11);

        jLabel12.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel12.setText("System Logo & Title");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BidDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BidDisplay().setVisible(true);
            }
        });
    }
